...
@section('content')
    <div class="container d-fix justify-content-center mt-3">
        <div class='w-75'>
            <h1>ショッピングカート</h1>
            <div class='row'>
                    ...
                    @foreach ($cart as $product )
                        <div class='col-md-2 mt-2'>
                            <a href="{{route('products.show',$product->id)}}"
                                imq src="{{aset("img/dummy.png")}}" class="img-fuild w-100">
                            </a>
                        </div>
            ...
            <div class="offset-8 col-4">
                <div class='row'>
                    ...
                    <form metohd="post" action="{{route(carts.destroy)}}"class="d-flex justify-content-end mt-3">
                        {{csrf_field()}}
                        ...
                        @if($total>0)
                        <div class='btn samuraimart-submit-button' data-toggle="modal" data-target="#buy-confirm-modal">購入を決定する</div>
                        @else
                        ...
                        <div class='modal-dialog'>
                            <div class='modal-content'>
                                <div class='modal-header'>
                                    <h5 class='modal-title' id='staticBackdropLabel'>購入確定しますか</h5>
